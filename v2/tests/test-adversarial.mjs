...
const base={materialUnknowns:[],materialLimitedCodes:[],componentFailures:[],unknown:[],limited:[],payrollRetro:1000,accountedActualRetro:1000,reconstructedRetro:1000};
...
const cases=[
  ...
  ['known retro dollars not covered by reconstruction', decideAuditResult({metadata,gross:cleanGross,fullAudit:{...base,accountedActualRetro:975}}).status, 'cannot-determine'],
  ...
  ['unresolved call pay', decideAuditResult({metadata,gross:cleanGross,fullAudit:{...base,materialUnknowns:[{payCode:'Call Pay'}],unknown:[{payCode:'Call Pay'}]}}).status, 'partially-verified'],
  ...
  ['separate later differential payment', assessPaymentCompleteness({summary:{byPayCode:[{payCode:'Night Shift Differential'}]},fullAudit:base}).status, 'known-additional-payment-separate'],
];
