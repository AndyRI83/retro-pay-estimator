...
assert.equal(assessPaymentCompleteness({ summary: summary(['Regular Pay','Night Shift Differential']), fullAudit:{materialUnknowns:[]} }).status,'known-additional-payment-pending');
assert.equal(assessPaymentCompleteness({ summary: summary(['Regular Pay','Charge Pay']), fullAudit:{materialUnknowns:[]} }).status,'known-additional-payment-pending');
