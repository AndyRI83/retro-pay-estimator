...
assert.equal(summary.limitedCodes.length, 1);
assert.equal(summary.limitedCodes[0].payCode, 'Certification Bonus');
...
console.log(JSON.stringify({ok:true, recognized:['Bereavement','Scheduled Personal'], limited:['Certification Bonus']}, null, 2));
